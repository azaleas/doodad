...
/*Base Container to create appliances for home and rooms*/

class CreateApplianceContainer extends Component {
    ...
    formSubmit = (event) =>{
        ...
        if(this.props.roomId){
            api.createRoomAppliance(data, this.props.roomId)
                .then((response) => this.createResponse())
        }
        else{
    ...
    render() {
        ...
        const address = (this.props.roomId ? `/rooms/${this.props.roomId}` : "/home");
        return (
            (this.state.redirect)
            ?(
                <Redirect to={address} />
            ...
            :(
                <div className="create-appliance">
                    <Modal 
                        trigger={
                            <div className="addblock--trigger">
                                {`${this.props.title} Appliance`} 
                            </div>
                        } 
...
CreateApplianceContainer.propTypes = {
    className: PropTypes.string,
    roomId: PropTypes.number,
    title: PropTypes.string,
};

export default CreateApplianceContainer;
