...
describe('MachineComponent', () => {
    ...
    it('should update `isLoading` state when `onSave` event is fired', () => {
        wrapper.setState({isLoading: false, switchToggle: false, switchToggleInitial: true});
    ...
    it('should update `mode`, `switchToggle` and `modeState` \
        states when `modalClose` event is fired', () => {
        wrapper.setState({
            saving: false,
            modeInitial: "",
